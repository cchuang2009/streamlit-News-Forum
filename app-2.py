...
filtered_df = df[(df["Publish_date"].dt.strftime("%Y-%b") == selected_month) & (df["Title"].str.contains(search_term, case=False))]
...
last_5_articles = df.head()[["Title", "Source", "Publish_date"]].values.tolist()[::-1]
